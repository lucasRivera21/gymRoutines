...
@user.get("/{user_id}", status_code=200)
...
@user.put("/{user_id}/name", status_code=200)
...
@user.put("/{user_id}/email", status_code=200)
...
@user.put("/{user_id}/gender", status_code=200)
...
@user.put("/{user_id}/password", status_code=200)
